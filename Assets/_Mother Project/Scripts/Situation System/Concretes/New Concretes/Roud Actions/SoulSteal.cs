...
public class SoulSteal : ICommand
{
    ...
    public async UniTask Execute()
    {
        ...
        if (ActionResolver.instance.ActionAccuracyCalculation(actionAccuracy))
        {
            ...
            playerTempStats.CurrentHealth = HealthManager.instance.HealthCap(player.HealthPoints, HealthManager.instance.HealthCalculation(( damage * -1), playerTempStats.CurrentHealth));
